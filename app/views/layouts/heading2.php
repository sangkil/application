...
?>
<!-- Logo -->
<a href="index2.html" class="logo">SangkilBiz3</a>
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span class="hidden-xs"><?php echo (!Yii::$app->user->isGuest) ? Yii::$app->user->identity->username : 'Guest'; ?></span>
                </a>
                <ul class="dropdown-menu">
                    <!-- User image -->
                    <li class="user-header">
                        <img src="<?= $baseurl ?>/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image" />
                        <p>
                            <?php echo (!Yii::$app->user->isGuest) ? Yii::$app->user->identity->username : 'Guest'; ?>
