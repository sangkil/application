...
<div class="col-lg-12 good-movement-view">
    ...
    echo Toolbar::widget(['items' => [
            ...
            ['label' => 'Apply', 'url' => ['apply', 'id' => $model->id], 'icon' => 'fa fa-trash-o', 'linkOptions' => ['class' => 'btn btn-primary btn-sm', 'data' => ['confirm' => 'Are you sure you want to apply this item?', 'method' => 'post']]],
