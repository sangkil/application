...
<div class="product-index">
    ...
    echo Toolbar::widget(['items' => [
            ...
            ['label' => '', 'url' => ['print-pdf'], 'icon' => 'fa fa-file-o', 'linkOptions' => ['class' => 'btn bg-orange btn-sm', 'target'=>'_blank', 'title'=>'Export to Pdf']],
            ['label' => '', 'url' => ['print-xsl'], 'icon' => 'fa fa-th', 'linkOptions' => ['class' => 'btn bg-olive btn-sm', 'target'=>'_blank', 'title'=>'Export to Excel']],
    ]]);
    ?>
