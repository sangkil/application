...
<div class="product-index">
    ...
    echo Toolbar::widget(['items' => [
            ...
            ['label' => '', 'url' => ['print-html'], 'icon' => 'fa fa-print', 'linkOptions' => ['class' => 'btn bg-navy btn-sm', 'target'=>'_blank']],
            ['label' => '', 'url' => ['print-pdf'], 'icon' => 'fa fa-file-o', 'linkOptions' => ['class' => 'btn bg-navy btn-sm', 'target'=>'_blank']],
            ['label' => '', 'url' => ['print-xsl'], 'icon' => 'fa fa-th', 'linkOptions' => ['class' => 'btn bg-navy btn-sm', 'target'=>'_blank']],
